...
if(isset($_GET['id'])) 
{
    $servico = localizaServicosPeloID($_GET['id']);
} else {
                    ...
                    <div class="row align-items-center mb-5 offset-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                <!-- Classe input-->
                                <input class="form-control" value="<?= $servico->classe ?>" id="classe" name="inputClasse" type="text" placeholder="Informe a classe *" data-sb-validations="required" />
